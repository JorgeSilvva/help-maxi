...
include('../models/conexao.php');
    ...
    {
        $data = $_GET['search'];
        $busca = "SELECT * FROM ticket WHERE ticket_id LIKE '%$data%' and usuario_id LIKE '%$data%' or setor LIKE '%$data%' or email LIKE '%$data%'or situacao LIKE '%$data%' ORDER BY ticket_id DESC";
    }
    else
    {
        $busca = "SELECT * FROM ticket ORDER BY ticket_id DESC";
    }
...
<footer class="footer">
    <div class="content has-text-centered">
        <p>Projeto Integrador III - <a href="menu.php">Home</a></p>
    </div>
</footer>
