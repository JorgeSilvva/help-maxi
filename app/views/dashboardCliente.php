...
<body>
    ...
    <a href="usuario.php"class="icon-a"><i class="fa fa-user icons"></i> &nbsp;&nbsp;Meus Dados</a>
...
<div id="main">
  ...
  <span style="font-size:30px;cursor:pointer; color: white;" class="nav2"  >&#9776; Dashboard</span>
	...
	<div class="col-div-3">
		<div class="box">
			<p>2<br/><span>Meus Tickets</span></p>
			<i class="fa fa-list box-icon"></i>
		</div>
	</div>
	<div class="col-div-3">
		<div class="box">
			<p>1<br/><span>Abertos</span></p>
			<i class="fa fa-tasks box-icon"></i>
		</div>
	</div>
	<div class="col-div-3">
		<div class="box">
			<p>1<br/><span>Resolvidos</span></p>
	...
	<div class="col-div-8">
		...
		<div class="content-box">
			<p>Ranking: chamados <span>Ano: <?php echo $ano ?></span></p>
			<br/>
			<table>
  <tr>
    <th>Assunto</th>
  ...
  <tr>
	...
	<div class="col-div-4">
		<div class="box-4">
		<div class="content-box">
    <p>Média <span>Data: <?php echo $dia . '/' . $mes ?></span></p>
    ...
    <div class="circle">
      ...
      <div class="inside-circle"> 49% </div>
    </div>
  </div>
		</div>
	</div>
